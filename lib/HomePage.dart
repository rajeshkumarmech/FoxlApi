import 'dart:convert';
import 'dart:ui';
import 'package:foxlapi/Saving_chit.dart';
import 'package:http/http.dart' as http;
import 'package:foxlapi/Chits_Investment.dart';
import 'package:foxlapi/about_us.dart';
import 'package:foxlapi/weeklyinvestment.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> getdataforweek() async {
      try {
        final response = await http.post(
            Uri.parse(
                'https://chitsoft.in/wapp/api/mobile3/week_chit_api.php'),
            body: {"cid": "111"});
        if (response.statusCode == 200) {
          final Map<String, dynamic> data = json.decode(response.body);
          String accountBalance = data['Account Balance'];
